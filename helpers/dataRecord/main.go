...
type BindFunction func(node neo4j.Node) types.CustomError
...
func (record *DataRecord) BindNode(bindFunction BindFunction) types.CustomError {
...
func (collections *DataRecordCollections) Bind(bindFunction BindFunction) ([]interface{}, types.CustomError) {
	var items []interface{}
