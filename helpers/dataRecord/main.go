...
type BindFunction func(node neo4j.Node) helperTypes.CustomError
...
func (record *DataRecord) BindNode(bindFunction BindFunction) helperTypes.CustomError {
...
func (collections *DataRecordCollections) Bind(bindFunction BindFunction) ([]interface{}, helperTypes.CustomError) {
	var items []interface{}
